...
|--------|------------------|-------------|----------|
| `normal` | 1K | 1024px | Quick previews, scenes without text |
| `2k` (default) | 2K | 2048px | Covers, illustrations, general use |

**Google imageSize**: Can be overridden with `--imageSize 1K|2K|4K`

## Text Clarity Guidelines

**For images with text, labels, or diagrams**, use highest quality settings:

```bash
# Diagrams/infographics with text labels - use 4K for sharp text
npx -y bun ${SKILL_DIR}/scripts/main.ts \
  --prompt "..." --image out.png --quality 2k --imageSize 4K
...
| Image Type | Recommended Settings | Why |
|------------|---------------------|-----|
| Diagrams with text | `--quality 2k --imageSize 4K` | Text must be readable |
| Infographics | `--quality 2k --imageSize 4K` | Labels and numbers must be sharp |
| Framework/Architecture | `--quality 2k --imageSize 4K` | Connections and labels need clarity |
| Cover images (no text) | `--quality 2k` | Default 2K is sufficient |
| Abstract/Scene | `--quality 2k` or `normal` | No fine text details |
